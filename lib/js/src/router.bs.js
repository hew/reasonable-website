...
function make() {
  ...
  newrecord[/* render */9] = (function (self) {
      ...
      return ReasonReact.element(/* None */0, /* None */0, Curry._2(Styletron.React[/* Provider */3][/* make */0], /* None */0, /* array */[React.createElement("div", undefined, React.createElement("ul", {
                                className: "nav"
                              }, React.createElement("li", undefined, ReasonReact.element(/* None */0, /* None */0, Link.make("home", Css$BsCssCore.beige, /* array */[Utils.str("Home")]))), React.createElement("li", undefined, ReasonReact.element(/* None */0, /* None */0, Link.make("repos", Css$BsCssCore.beige, /* array */[Utils.str("Repos")]))), React.createElement("li", undefined, ReasonReact.element(/* None */0, /* None */0, Link.make("future", Css$BsCssCore.beige, /* array */[Utils.str("Future")]))), React.createElement("li", undefined, ReasonReact.element(/* None */0, /* None */0, Link.make("restyled", Css$BsCssCore.beige, /* array */[Utils.str("Restyled")])))), React.createElement("div", {
                                className: "main"
                              }, tmp))]));
    });
